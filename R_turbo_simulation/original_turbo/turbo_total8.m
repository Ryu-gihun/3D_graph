...
for DB = 7:14
    ...
    while(1)
        ...
        gamma_map3 = cal_gamma(a_xz, perc_map, per_0, per_1, bottom, cal_length);
        ...
        per_0(1:num) = per_0(rule);
        per_1(1:num) = per_1(rule);
        gamma_map4 = cal_gamma(a_xz2, perc_map ,per_0, per_1, bottom, cal_length);
        ...
        [per_0, per_1] = percenti(input_lamda,num);
        gamma_map5 = cal_gamma(a_xz, perc_map, per_0, per_1, bottom, cal_length);
        ...
        per_0(1:num) = per_0(rule);
        per_1(1:num) = per_1(rule);
        gamma_map6 = cal_gamma(a_xz2, perc_map ,per_0, per_1, bottom, cal_length);
        ...
        [per_0, per_1] = percenti(input_lamda,num);
        gamma_map7 = cal_gamma(a_xz, perc_map, per_0, per_1, bottom, cal_length);
        ...
        per_0(1:num) = per_0(rule);
        per_1(1:num) = per_1(rule);
        gamma_map8 = cal_gamma(a_xz2, perc_map ,per_0, per_1, bottom, cal_length);
        ...
        [per_0, per_1] = percenti(input_lamda,num);
        gamma_map9 = cal_gamma(a_xz, perc_map, per_0, per_1, bottom, cal_length);
        ...
        per_0(1:num) = per_0(rule);
        per_1(1:num) = per_1(rule);
        gamma_map10 = cal_gamma(a_xz2, perc_map ,per_0, per_1, bottom, cal_length);
        ...
        [per_0, per_1] = percenti(input_lamda,num);
        gamma_map11 = cal_gamma(a_xz, perc_map, per_0, per_1, bottom, cal_length);
        ...
        per_0(1:num) = per_0(rule);
        per_1(1:num) = per_1(rule);
        gamma_map12 = cal_gamma(a_xz2, perc_map ,per_0, per_1, bottom, cal_length);
        ...
        [per_0, per_1] = percenti(input_lamda,num);
        gamma_map13 = cal_gamma(a_xz, perc_map, per_0, per_1, bottom, cal_length);
        ...
        per_0(1:num) = per_0(rule);
        per_1(1:num) = per_1(rule);
        gamma_map14 = cal_gamma(a_xz2, perc_map ,per_0, per_1, bottom, cal_length);
        ...
        [per_0, per_1] = percenti(input_lamda,num);
        gamma_map15 = cal_gamma(a_xz, perc_map, per_0, per_1, bottom, cal_length);
        ...
        per_0(1:num) = per_0(rule);
        per_1(1:num) = per_1(rule);
        gamma_map16 = cal_gamma(a_xz2, perc_map ,per_0, per_1, bottom, cal_length);
        ...
        if error_stack5 >= 100 && run_count > 100
            break;
        end
    end
