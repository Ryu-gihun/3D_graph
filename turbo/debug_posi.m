...
for  x = x_list
    for y = y_list
        ...
        while a == 0
            ...
            switch position
                case 1
                    ...
                    %d_A = t_1; d_B = t_3; d_C = t_4;
                case 2
                    d_A = t_2; d_B = t_4; d_C = t_3;
                    %d_A = t_3; d_B = t_4; d_C = t_8;
                case 3
                    d_A = t_3; d_B = t_4; d_C = t_8;
                    %d_A = t_4; d_B = t_8; d_C = t_9;
                case 4
                    d_A = t_4; d_B = t_5;d_C = t_8;
                    %d_A = t_4; d_B = t_7; d_C = t_9;
                case 5
        ...
        if keeprun == 1
            ...
            graph1 = extend_graph(graph1, 10, 10);  % 좌우 3dB씩 확장
            graph2 = extend_graph(graph2, 10, 10);
            graph3 = extend_graph(graph3, 10, 10);
            ...
            if exitflag > 0
                ...
                for x_range = (7-delta): 0.5 : (16-delta)
                    ...
                    %ber_val = ( w1*y1_val + w2*y2_val + w3*y3_val ) / (w1+w2+w3);
